  ...
  return (
    ...
    >
      ...
      <div className={cn("space-y-6", isLeft ? "" : "md:col-start-2")}>
        ...
        <button className="px-6 py-2.5 text-white bg-[#0D101C80] hover:bg-accent rounded-full text-sm font-medium transition-colors">
          CASE STUDY
        </button>
      </div>
      ...
      <motion.div
        ...
        className={cn(
          "relative",
          isLeft ? "" : "md:col-start-1 md:row-start-1"
        )}
      >
